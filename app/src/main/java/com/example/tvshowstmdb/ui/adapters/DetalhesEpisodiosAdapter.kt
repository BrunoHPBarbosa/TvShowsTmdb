...
import com.example.tvshowstmdb.data.model.seasons.Episode
...
class DetalhesEpisodiosAdapter :
    RecyclerView.Adapter<DetalhesEpisodiosAdapter.DetalhesSeriesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetalhesSeriesViewHolder {
        val binding =
            ItemDetalhesEpisodiosBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: DetalhesSeriesViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            txtTempoEpisodio.text =
                "${episodio.runtime} ${holder.itemView.context.getString(R.string.min)}"
            txtDescricaoEpisodio.text = episodio.overview
            if (episodio.overview.isNullOrEmpty()) {
                txtDescricaoEpisodio.text =
                    holder.itemView.context.getString(R.string.text_sem_descricao)
            }
